...
type MutationResolver interface {
	CreateTask(ctx context.Context, input api.CreateTaskRequest) (api.Task, error)
}
type QueryResolver interface {
	Todos(ctx context.Context) ([]api.Task, error)
}

func field_Mutation_createTask_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 api.CreateTaskRequest
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		arg0, err = UnmarshalCreateTaskRequest(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createTask(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateTask(rctx, args["input"].(api.CreateTaskRequest))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
...
// nolint: vetshadow
func (ec *executionContext) _Task_id(ctx context.Context, field graphql.CollectedField, obj *api.Task) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Task",
...
// nolint: vetshadow
func (ec *executionContext) _Task_text(ctx context.Context, field graphql.CollectedField, obj *api.Task) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Task",
...
// nolint: vetshadow
func (ec *executionContext) _Task_done(ctx context.Context, field graphql.CollectedField, obj *api.Task) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Task",
...
func UnmarshalCreateTaskRequest(v interface{}) (api.CreateTaskRequest, error) {
