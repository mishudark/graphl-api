...
var (
	...
	LatencyMs = stats.Float64("graphql/latency", "The latency in milliseconds", "ms")

	// Hits counts the number of hits to  the endpoint
	Hits = stats.Int64("graphql/lines_in", "The number of hits to the endpoint", "1")

	// Errors encounters the number of errors
	Errors = stats.Int64("graphql/errors", "The number of errors encountered", "1")
)
